...
export declare const SignaturePolicySuites: Readonly<{
    ...
    ALLOW_ENCRYPT_ALLOW_DECRYPT: Readonly<{
        ...
        defaultAlgorithmSuite: AlgorithmSuiteIdentifier;
    }>;
...
export declare type NonCommittingAlgorithmSuiteIdentifier = Exclude<AlgorithmSuiteIdentifier, typeof AlgorithmSuiteIdentifier.ALG_AES256_GCM_IV12_TAG16_HKDF_SHA512_COMMIT_KEY | typeof AlgorithmSuiteIdentifier.ALG_AES256_GCM_IV12_TAG16_HKDF_SHA512_COMMIT_KEY_ECDSA_P384>;
...
export declare const CommitmentPolicySuites: Readonly<{
    isEncryptEnabled(commitmentPolicy: CommitmentPolicy, suite?: AlgorithmSuiteIdentifier | AlgorithmSuite | undefined): void;
...
export declare type Commitment = 'NONE' | 'KEY';
export declare type NodeHash = 'sha256' | 'sha384' | 'sha512';
export declare type WebCryptoHash = 'SHA-256' | 'SHA-384' | 'SHA-512';
...
export declare type CommitmentLength = 256;
export declare type HKDFSaltLengthBytes = 32;
export declare type IvLength = 12;
export declare type TagLength = 128;
export declare type SuiteDataLength = 32;
...
declare type AlgUnion = AlgBasic | AlgKdf | AlgKdfSigned | AlgCommitted | AlgCommittedSigned;
declare type AlgorithmSuiteValues = AesGcm & Partial<Omit<AlgBasic, keyof AesGcm>> & Partial<Omit<AlgKdf, keyof AesGcm>> & Partial<Omit<AlgKdfSigned, keyof AesGcm>> & Partial<Omit<AlgCommitted, keyof AesGcm>> & Partial<Omit<AlgCommittedSigned, keyof AesGcm>>;
